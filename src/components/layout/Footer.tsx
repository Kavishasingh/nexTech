    ...
    <footer className="bg-white border-t border-slate-200 py-12 mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-[#0F2942]">Legal</h3>
            <ul className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm text-slate-600">
              ...
              <li><Link href="/terms-of-service" className="hover:text-[#D97706] transition-colors">Terms of Service</Link></li>
              <li><Link href="/privacy-policy" className="hover:text-[#D97706] transition-colors">Privacy Policy</Link></li>
              <li><Link href="/refund-cancellation" className="hover:text-[#D97706] transition-colors">Refund & Cancellation Policy</Link></li>
            </ul>
          </div>
        </div>
