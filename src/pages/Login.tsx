      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="font-serif font-bold text-2xl text-foreground">OkSchool</span>
          </div>
          <p className="text-muted-foreground text-sm">Free knowledge for every student.</p>
        </div>
